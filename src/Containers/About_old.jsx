        ...
        <>
          ...
          <CanvasExtend bgColor={"#4B65C6"}>
            <Canvas shadows camera={{ position: [-1, 0, 3], near: 0.1, far: 40 }} dpr={1}>
              ...
              <spotLight intensity={3} color="white" angle={0.3} penumbra={1} position={[0, 1, 4]} castShadow shadow-mapSize={[512, 512]} />
              <spotLight intensity={5} color="white" angle={0.3} penumbra={1} position={[-2, 3, -3]} castShadow shadow-mapSize={[512, 512]} />
              <spotLight intensity={4} color="white" angle={1} penumbra={1} position={[0, 1.75, 0]} castShadow shadow-mapSize={[512, 512]} />
