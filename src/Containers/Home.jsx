...
export const Home = () => {
  ...
  return (
    <>
{    Alter ?  <Canvas shadows gl={{ antialias: false }} dpr={[3, 1.5]} camera={{ position: [0, 0, 20], fov: 20, near: 1, far: 40 }}>
        <Stats />
        ...
        <Physics gravity={[0, -9.81, 0]} iterations={10}>
          ...
          <ClumpBox nodes={nodes} number={1} amount={1} shapeColor="#F5C163" />
          <ClumpBox nodes={nodes} number={2} amount={1} shapeColor="#4B65C6" />
          <ClumpBox nodes={nodes} number={3} amount={1} shapeColor="#F19A62" />
          <ClumpBox nodes={nodes} number={4} amount={1} shapeColor="#72CD90" />
          <ClumpBox nodes={nodes} number={5} amount={1} shapeColor="#645299" />

          <ClumpBox nodes={nodes} number={1} amount={2} shapeColor="#d2d2d2" />
          <ClumpBox nodes={nodes} number={2} amount={7} shapeColor="#c1c1c1" />
          <ClumpBox nodes={nodes} number={3} amount={4} shapeColor="#e3e3e3" />
          <ClumpBox nodes={nodes} number={4} amount={7} shapeColor="#a1a1a1" />
          <ClumpBox nodes={nodes} number={5} amount={5} shapeColor="#d6d6d6" />
...
function ClumpBoxOriginal({ mat = new THREE.Matrix4(), vec = new THREE.Vector3(), amount, number, shapeColor, shape, ...props }) {
  const { nodes } = useGLTF("/portfolio_shapes.glb")
