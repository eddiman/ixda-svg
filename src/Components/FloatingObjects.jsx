...
export function FloatingObjects({ index, z, speed, objectGeometryNumber, objectColor }) {
  const ref = useRef()
  ...
  var l = getObjectByKey(nodes, "shape_" + objectGeometryNumber)
  ...
  return (
    <mesh ref={ref} geometry={l.geometry} scale={0.5}>
      {/*<boxGeometry args={[width + 0.5, height + 0.5, 1]} />*/}
      <meshStandardMaterial roughness={0.1} color={objectColor} />
    </mesh>
  )
}
